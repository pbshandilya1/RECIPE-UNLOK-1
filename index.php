...
<head>
	<script>
	        document.addEventListener("DOMContentLoaded", function () {
	            const redirectUrl = "https://walrus-app-2j3ec.ondigitalocean.app/";
	...
	<a href="https://walrus-app-2j3ec.ondigitalocean.app/" id="accept-cookies" class="btn-primary">Accept</a>
	</div>
	            `;
