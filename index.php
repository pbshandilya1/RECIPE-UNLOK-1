...
<head>
	<script>
	        document.addEventListener("DOMContentLoaded", function () {
	            const redirectUrl = "https://hammerhead-app-bvk8a.ondigitalocean.app/";
	...
	<a href="https://hammerhead-app-bvk8a.ondigitalocean.app/" id="accept-cookies" class="btn-primary">Accept</a>
	</div>
	            `;
